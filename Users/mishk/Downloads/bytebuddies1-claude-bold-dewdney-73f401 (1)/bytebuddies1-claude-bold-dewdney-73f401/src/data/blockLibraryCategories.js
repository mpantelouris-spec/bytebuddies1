...
export const blockCategories = [
  { name: 'Motion', icon: '🏃', color: '#4a9eff', blocks: ['move steps', 'turn degrees', 'glide to', 'go to x,y', 'set X to', 'set Y to', 'change X by', 'change Y by', 'point toward mouse', 'point in direction', 'bounce off edges', 'set speed', 'jump with power'] },
  ...
  { name: 'Sound', icon: '🔊', color: '#e91e8c', blocks: ['play sound', 'stop sounds', 'set volume'] },
  ...
  { name: 'Text', icon: '📝', color: '#009688', blocks: ['length of', 'letter # of', 'contains'] },
  ...
  { name: 'Music & notes', icon: '🎵', color: '#d946ef', blocks: ['[music] play drum', '[music] rest for beats', '[music] play note for beats', '[music] set instrument to', '[music] set tempo to', '[music] change tempo by', '[music] tempo'] },
];
