...
export const BLOCK_DEFS = {
  ...
  'physics-jump':       { label: 'Physics jump', icon: '⬆️', color: '#f59e0b', category: 'physics', params: { power: '10' } },
  ...
  'motion-jump':        { label: 'Jump with power', icon: '⬆️', color: '#f59e0b', category: 'motion', params: { power: '15' } },
  // My Blocks
...
export const SIDEBAR_TO_TYPE = {
  ...
  'set y to': 'motion-sety', 'set speed': 'motion-speed', 'stop motion': 'motion-stop',
  'set rotation': 'motion-rotation', 'change angle by': 'motion-change-angle', 'wrap around': 'motion-wrap',
