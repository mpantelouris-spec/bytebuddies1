import { getExtensionSidebarCategories } from './extensionsCatalog';
...
export const blockCategories = [
  ...
  { name: 'Control',   icon: '🔧', color: '#ff7043', blocks: ['wait','repeat N times','forever','if / else','while condition','stop all','for each in list'] },
