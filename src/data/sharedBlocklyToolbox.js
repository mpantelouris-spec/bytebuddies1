...
export const BLOCKLY_TYPE_TO_SIDEBAR_NAME = {
  ...
  bb_motion_jump: 'jump with power',
  ...
  bb_math_add: 'add',
  bb_math_mult: 'multiply',
  bb_math_random: 'pick random to',
  bb_math_round: 'round',
  operator_add: 'add',
  operator_multiply: 'multiply',
  operator_random: 'pick random to',
  operator_compare: 'greater than',
  ...
  operator_not: 'not',
  operator_join: 'join',
  operator_letterof: 'letter of',
  operator_length: 'length of',
  operator_contains: 'contains',
  operator_mod: 'mod',
  operator_round: 'round',
  operator_mathop: 'math operation of',
  bb_sprite_say: 'say',
