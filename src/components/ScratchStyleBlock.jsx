...
const C_BLOCK_TYPES = new Set(['loop-repeat', 'loop-forever', 'loop-while', 'loop-foreach', 'logic-if', 'control-repeat-until']);
const BOOLEAN_BLOCK_TYPES = new Set([
  'logic-bool', 'logic-and', 'logic-or', 'logic-not', 'logic-compare',
  'text-contains',
  'sense-touching', 'sense-touching-sprite', 'sense-touching-color', 'sense-color-touching-color',
  'sense-key', 'sense-mouse-down',
]);
const REPORTER_BLOCK_TYPES = new Set([
  'sense-mouse-x', 'sense-mouse-y', 'sense-distance', 'sense-timer', 'sense-loudness', 'sense-answer',
  'sense-of', 'sense-current', 'sense-days-since-2000', 'sense-username',
  'math-add', 'math-subtract', 'math-mult', 'math-divide', 'math-modulo', 'math-random', 'math-round',
  'text-join', 'text-length', 'text-letter',
  'sprite-x-reporter', 'sprite-y-reporter', 'sprite-direction-reporter',
  'looks-costume-reporter', 'looks-backdrop-reporter', 'sprite-size-reporter', 'sound-get-volume',
]);
