...
export const EXTENSION_SHORT_TO_BLOCKLY = {
  ...
  // QR Code
  'qr-video-on': 'qr_turn_video_on',
  'qr-bounding-box': 'qr_bounding_box',
  'qr-analyse-camera': 'qr_analyse_camera',
  'qr-detected': 'qr_is_detected',
  'qr-data': 'qr_get_data',
  'qr-position': 'qr_position',
  'qr-angle': 'qr_get_angle',
  ...
  'ml-train': 'ml_train',
  'ml-training-open': 'ml_training_open',

  // Chat & NLP
  'chat-ask': 'bb_chat_ask',
  'action-print': 'bb_action_print',
...
export const EXTENSION_BLOCKLY_TO_GAME = {
  ...
  qr_turn_video_on: 'qr-video-on',
  qr_bounding_box: 'qr-bounding-box',
  qr_analyse_camera: 'qr-analyse-camera',
  qr_is_detected: 'qr-detected',
  qr_get_data: 'qr-data',
  qr_position: 'qr-position',
  qr_get_angle: 'qr-angle',
  ...
  ml_train: 'ml-train',
  ml_training_open: 'ml-training-open',
  bb_chat_ask: 'chat-ask',
  chat_ask: 'chat-ask',
