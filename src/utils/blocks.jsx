...
/* ─── Category to Color Mapping (Original BlockEditor colors) ─── */
...
export const BLOCK_DEFS = {
  ...
  'loop-forever':     { label: 'Forever', icon: '🔁', color: '#059669', category: 'loop', params: {} },
  ...
  'sprite-changex':   { label: 'Change X by', icon: '🎭', color: '#3b82f6', category: 'sprite', params: { amount: '10' } },
  'sprite-changey':   { label: 'Change Y by', icon: '🎭', color: '#3b82f6', category: 'sprite', params: { amount: '10' } },
  'sprite-setsize':   { label: 'Set size to', icon: '🎭', color: '#3b82f6', category: 'sprite', params: { size: '100' } },
  'sprite-show':      { label: 'Show', icon: '🎭', color: '#3b82f6', category: 'sprite', params: {} },
  'sprite-hide':      { label: 'Hide', icon: '🎭', color: '#3b82f6', category: 'sprite', params: {} },
  'sprite-say':       { label: 'Say', icon: '🎭', color: '#3b82f6', category: 'sprite', params: { text: '"Hi!"', secs: '2' } },
  'control-wait':     { label: 'Wait', icon: '⏱', color: '#059669', category: 'control', params: { secs: '1' } },
  'control-stop':     { label: 'Stop all', icon: '⏹', color: '#059669', category: 'control', params: {} },
  ...
  // Sensing
  'sense-touching':     { label: 'Touching edge?', icon: '🔍', color: '#06b6d4', category: 'sensing', params: {} },
  'sense-touching-sprite': { label: 'Touching sprite?', icon: '🔍', color: '#06b6d4', category: 'sensing', params: { sprite: 'any' } },
  'sense-key':          { label: 'Key pressed?', icon: '⌨️', color: '#06b6d4', category: 'sensing', params: { key: 'space' } },
  'sense-mouse-x':      { label: 'Mouse X', icon: '🖱️', color: '#06b6d4', category: 'sensing', params: {} },
  'sense-mouse-y':      { label: 'Mouse Y', icon: '🖱️', color: '#06b6d4', category: 'sensing', params: {} },
  'sense-distance':     { label: 'Distance to mouse', icon: '📏', color: '#06b6d4', category: 'sensing', params: {} },
  'sense-timer':        { label: 'Timer', icon: '⏱️', color: '#06b6d4', category: 'sensing', params: {} },
  'sense-reset-timer':  { label: 'Reset timer', icon: '⏱️', color: '#06b6d4', category: 'sensing', params: {} },
  // Looks
  'looks-say':          { label: 'Say', icon: '💬', color: '#9333ea', category: 'looks', params: { text: 'Hello!', secs: '2' } },
  'looks-think':        { label: 'Think', icon: '💭', color: '#9333ea', category: 'looks', params: { text: 'Hmm...', secs: '2' } },
  'looks-costume':      { label: 'Switch costume to', icon: '👗', color: '#9333ea', category: 'looks', params: { costume: '1' } },
  'looks-next-costume': { label: 'Next costume', icon: '👗', color: '#9333ea', category: 'looks', params: {} },
  'looks-color-effect': { label: 'Set color effect', icon: '🎨', color: '#9333ea', category: 'looks', params: { value: '0' } },
  'looks-ghost-effect': { label: 'Set ghost effect', icon: '👻', color: '#9333ea', category: 'looks', params: { value: '0' } },
  'looks-clear-effects':{ label: 'Clear all effects', icon: '✨', color: '#9333ea', category: 'looks', params: {} },
  'looks-grow':         { label: 'Grow by', icon: '🔼', color: '#9333ea', category: 'looks', params: { amount: '10' } },
  'looks-shrink':       { label: 'Shrink by', icon: '🔽', color: '#9333ea', category: 'looks', params: { amount: '10' } },
  'looks-front':        { label: 'Go to front layer', icon: '🎨', color: '#9333ea', category: 'looks', params: {} },
  'looks-back':         { label: 'Go to back layer', icon: '🎨', color: '#9333ea', category: 'looks', params: {} },
  // Physics
  ...
  // Game
  'game-score-add':     { label: 'Add to score', icon: '🏆', color: '#e11d48', category: 'game', params: { amount: '10' } },
  'game-score-set':     { label: 'Set score to', icon: '🏆', color: '#e11d48', category: 'game', params: { value: '0' } },
  'game-lose-life':     { label: 'Lose a life', icon: '❤️', color: '#e11d48', category: 'game', params: {} },
  'game-set-lives':     { label: 'Set lives to', icon: '❤️', color: '#e11d48', category: 'game', params: { value: '3' } },
  'game-over':          { label: 'Game Over', icon: '💀', color: '#e11d48', category: 'game', params: {} },
  'game-win':           { label: 'You Win!', icon: '🎉', color: '#e11d48', category: 'game', params: {} },
  'game-next-level':    { label: 'Next Level', icon: '⬆️', color: '#e11d48', category: 'game', params: {} },
  'game-spawn':         { label: 'Spawn clone of', icon: '✨', color: '#e11d48', category: 'game', params: { sprite: 'this' } },
  'game-destroy':       { label: 'Destroy this', icon: '💥', color: '#e11d48', category: 'game', params: {} },
  'game-pause':         { label: 'Pause game', icon: '⏸️', color: '#e11d48', category: 'game', params: {} },
  // Motion extras
  'motion-glide':       { label: 'Glide to', icon: '🕊️', color: '#3b82f6', category: 'motion', params: { x: '0', y: '0', secs: '1' } },
  'motion-point':       { label: 'Point toward mouse', icon: '🎯', color: '#3b82f6', category: 'motion', params: {} },
  'motion-point-dir':   { label: 'Point in direction', icon: '🎯', color: '#3b82f6', category: 'motion', params: { direction: '90' } },
  'motion-setx':        { label: 'Set X to', icon: '🎭', color: '#3b82f6', category: 'motion', params: { x: '0' } },
  'motion-sety':        { label: 'Set Y to', icon: '🎭', color: '#3b82f6', category: 'motion', params: { y: '0' } },
  'motion-speed':       { label: 'Set speed to', icon: '⚡', color: '#3b82f6', category: 'motion', params: { speed: '5' } },
  // My Blocks
  'myblock-define':     { label: 'Define my block', icon: '🧩', color: '#3b82f6', category: 'myblocks', params: { name: 'my block' } },
  'myblock-run':        { label: 'Run my block', icon: '🧩', color: '#3b82f6', category: 'myblocks', params: { name: 'my block' } },
};
