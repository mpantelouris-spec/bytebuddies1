...
export const BLOCK_DEFS = {
  ...
  'var-hide':         { label: 'Hide variable', icon: '📦', color: '#f59e0b', category: 'variable', params: { name: 'myVar' } },
  'var-reporter':     { label: 'Variable value', icon: '📦', color: '#f59e0b', category: 'variable', params: { name: 'myVar' } },
  ...
  'motion-move':      { label: 'Move steps', icon: '🎭', color: '#4a9eff', category: 'motion', params: { steps: '10' } },
  'motion-turn':      { label: 'Turn degrees', icon: '🎭', color: '#4a9eff', category: 'motion', params: { degrees: '90' } },
  'motion-turn-right': { label: 'Turn right', icon: '🎭', color: '#4a9eff', category: 'motion', params: { degrees: '15' } },
  'motion-turn-left': { label: 'Turn left', icon: '🎭', color: '#4a9eff', category: 'motion', params: { degrees: '15' } },
  'motion-goto':      { label: 'Go to', icon: '🎯', color: '#4a9eff', category: 'motion', params: { target: 'random' } },
  'motion-glide':     { label: 'Glide to', icon: '🌊', color: '#4a9eff', category: 'motion', params: { secs: '1', target: 'random' } },
  'motion-point-towards': { label: 'Point towards', icon: '🧭', color: '#4a9eff', category: 'motion', params: { target: 'mouse-pointer' } },
  ...
  'sprite-setsize':   { label: 'Set size to () %', icon: '🔼', color: '#9b59b6', category: 'looks', params: { size: '100' } },
  ...
  'sound-change-volume': { label: 'Change volume by', icon: '🔊', color: '#f59e0b', category: 'sound', params: { change: '10' } },
  ...
  'robot-generic':      { label: 'Robot command', icon: '🤖', color: '#64748b', category: 'robot', params: { cmd: 'move', v1: '0', v2: '0', v3: '0' } },
  'robot-show-text':    { label: 'Show text on robot', icon: '🤖', color: '#64748b', category: 'robot', params: { text: 'Hi' } },
  'robot-show-number':  { label: 'Show number on robot', icon: '🤖', color: '#64748b', category: 'robot', params: { value: '0' } },
  'robot-show-icon':    { label: 'Show icon on robot', icon: '🤖', color: '#64748b', category: 'robot', params: { icon: 'heart' } },
  'robot-led-color':    { label: 'Set LED color', icon: '💡', color: '#64748b', category: 'robot', params: { color: 'red' } },
  'robot-led-rgb':      { label: 'Set LED RGB', icon: '💡', color: '#64748b', category: 'robot', params: { r: '255', g: '0', b: '0' } },
  'robot-led-brightness': { label: 'Set LED brightness', icon: '💡', color: '#64748b', category: 'robot', params: { brightness: '100' } },
  'robot-buzz':         { label: 'Buzz', icon: '🔔', color: '#64748b', category: 'robot', params: { ms: '200' } },
  'robot-play-note':    { label: 'Play note', icon: '🎵', color: '#64748b', category: 'robot', params: { note: '60', duration: '0.25' } },
  'robot-play-melody':  { label: 'Play melody', icon: '🎶', color: '#64748b', category: 'robot', params: { melody: 'scale' } },
  'robot-if-dist':      { label: 'If distance', icon: '📏', color: '#64748b', category: 'robot', params: { op: '<', cm: '10' } },
...
export const SIDEBAR_TO_TYPE = {
  ...
  'create variable': 'var-create', 'set variable': 'var-set', 'change by': 'var-change',
  'wait': 'control-wait',
  ...
  'set volume': 'sound-set-volume', 'play note': 'sound-play',
...
export const BLOCKLY_TO_GAME_TYPE = {
  ...
  event_broadcastandwait: 'event-broadcast-wait',
  event_whenbroadcastreceived: 'event-message',
  event_whenreceivemessage: 'event-message',
  event_whenbackdropswitchesto: 'event-backdropswitch',
  event_whengreaterthan: 'event-loudness',
  motion_goto: 'motion-goto',
  motion_glide: 'motion-glide',
  looks_switchcostume: 'looks-costume',
  ...
  sound_changevolumeby: 'sound-change-volume',
  data_variable: 'var-reporter',
  bb_robot_generic: 'robot-generic',
  bb_robot_show_text: 'robot-show-text',
  bb_robot_show_number: 'robot-show-number',
  bb_robot_show_icon: 'robot-show-icon',
  bb_robot_led_color: 'robot-led-color',
  bb_robot_led_rgb: 'robot-led-rgb',
  bb_robot_led_brightness: 'robot-led-brightness',
  bb_robot_buzz: 'robot-buzz',
  bb_robot_play_note: 'robot-play-note',
  bb_robot_play_melody: 'robot-play-melody',
  bb_robot_if_dist: 'robot-if-dist',
