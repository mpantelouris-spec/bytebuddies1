...
export const BLOCK_DEFS = {
  ...
  'event-collision':  { label: 'On collision', icon: '💥', color: '#ef4444', category: 'event', params: { with: 'any' } },
  ...
  'sprite-move':      { label: 'Move', icon: '🎭', color: '#4fc3f7', category: 'sprite', params: { steps: '10' } },
  'sprite-turn':      { label: 'Turn', icon: '🎭', color: '#4fc3f7', category: 'sprite', params: { degrees: '90' } },
  'sprite-goto':      { label: 'Go to', icon: '🎭', color: '#4fc3f7', category: 'sprite', params: { x: '0', y: '0' } },
  'sprite-changex':   { label: 'Change X by', icon: '🎭', color: '#4fc3f7', category: 'sprite', params: { amount: '10' } },
  'sprite-changey':   { label: 'Change Y by', icon: '🎭', color: '#4fc3f7', category: 'sprite', params: { amount: '10' } },
  'sprite-setsize':   { label: 'Set size to', icon: '🎭', color: '#4fc3f7', category: 'sprite', params: { size: '100' } },
  'sprite-show':      { label: 'Show', icon: '🎭', color: '#4fc3f7', category: 'sprite', params: {} },
  'sprite-hide':      { label: 'Hide', icon: '🎭', color: '#4fc3f7', category: 'sprite', params: {} },
  'sprite-say':       { label: 'Say', icon: '🎭', color: '#4fc3f7', category: 'sprite', params: { text: '"Hi!"', secs: '2' } },
  'control-wait':     { label: 'Wait', icon: '⏱', color: '#f59e0b', category: 'control', params: { secs: '1' } },
  'control-stop':     { label: 'Stop all', icon: '⏹', color: '#ef4444', category: 'control', params: {} },
  ...
  // Sensing
  'sense-touching':     { label: 'Touching edge?', icon: '🔍', color: '#5bc0de', category: 'sensing', params: {} },
  'sense-touching-sprite': { label: 'Touching sprite?', icon: '🔍', color: '#5bc0de', category: 'sensing', params: { sprite: 'any' } },
  'sense-key':          { label: 'Key pressed?', icon: '⌨️', color: '#5bc0de', category: 'sensing', params: { key: 'space' } },
  'sense-mouse-x':      { label: 'Mouse X', icon: '🖱️', color: '#5bc0de', category: 'sensing', params: {} },
  'sense-mouse-y':      { label: 'Mouse Y', icon: '🖱️', color: '#5bc0de', category: 'sensing', params: {} },
  'sense-distance':     { label: 'Distance to mouse', icon: '📏', color: '#5bc0de', category: 'sensing', params: {} },
  'sense-timer':        { label: 'Timer', icon: '⏱️', color: '#5bc0de', category: 'sensing', params: {} },
  'sense-reset-timer':  { label: 'Reset timer', icon: '⏱️', color: '#5bc0de', category: 'sensing', params: {} },
  // Looks
  'looks-say':          { label: 'Say', icon: '💬', color: '#9b59b6', category: 'looks', params: { text: 'Hello!', secs: '2' } },
  'looks-think':        { label: 'Think', icon: '💭', color: '#9b59b6', category: 'looks', params: { text: 'Hmm...', secs: '2' } },
  'looks-costume':      { label: 'Switch costume to', icon: '👗', color: '#9b59b6', category: 'looks', params: { costume: '1' } },
  'looks-next-costume': { label: 'Next costume', icon: '👗', color: '#9b59b6', category: 'looks', params: {} },
  'looks-color-effect': { label: 'Set color effect', icon: '🎨', color: '#9b59b6', category: 'looks', params: { value: '0' } },
  'looks-ghost-effect': { label: 'Set ghost effect', icon: '👻', color: '#9b59b6', category: 'looks', params: { value: '0' } },
  'looks-clear-effects':{ label: 'Clear all effects', icon: '✨', color: '#9b59b6', category: 'looks', params: {} },
  'looks-grow':         { label: 'Grow by', icon: '🔼', color: '#9b59b6', category: 'looks', params: { amount: '10' } },
  'looks-shrink':       { label: 'Shrink by', icon: '🔽', color: '#9b59b6', category: 'looks', params: { amount: '10' } },
  'looks-front':        { label: 'Go to front layer', icon: '🎨', color: '#9b59b6', category: 'looks', params: {} },
  'looks-back':         { label: 'Go to back layer', icon: '🎨', color: '#9b59b6', category: 'looks', params: {} },
  // Physics
  'physics-velocity':   { label: 'Set velocity', icon: '💨', color: '#1abc9c', category: 'physics', params: { vx: '5', vy: '0' } },
  'physics-gravity':    { label: 'Set gravity', icon: '⬇️', color: '#1abc9c', category: 'physics', params: { amount: '0.5' } },
  'physics-bounce':     { label: 'Bounce off edges', icon: '↩️', color: '#1abc9c', category: 'physics', params: {} },
  'physics-friction':   { label: 'Set friction', icon: '🔄', color: '#1abc9c', category: 'physics', params: { amount: '0.9' } },
  'physics-jump':       { label: 'Jump with power', icon: '⬆️', color: '#1abc9c', category: 'physics', params: { power: '10' } },
  'physics-push':       { label: 'Push in direction', icon: '➡️', color: '#1abc9c', category: 'physics', params: { direction: '0', force: '5' } },
  // Game
  'game-score-add':     { label: 'Add to score', icon: '🏆', color: '#e74c3c', category: 'game', params: { amount: '10' } },
  'game-score-set':     { label: 'Set score to', icon: '🏆', color: '#e74c3c', category: 'game', params: { value: '0' } },
  'game-lose-life':     { label: 'Lose a life', icon: '❤️', color: '#e74c3c', category: 'game', params: {} },
  'game-set-lives':     { label: 'Set lives to', icon: '❤️', color: '#e74c3c', category: 'game', params: { value: '3' } },
  'game-over':          { label: 'Game Over', icon: '💀', color: '#e74c3c', category: 'game', params: {} },
  'game-win':           { label: 'You Win!', icon: '🎉', color: '#27ae60', category: 'game', params: {} },
  'game-next-level':    { label: 'Next Level', icon: '⬆️', color: '#e74c3c', category: 'game', params: {} },
  'game-spawn':         { label: 'Spawn clone of', icon: '✨', color: '#e74c3c', category: 'game', params: { sprite: 'this' } },
  'game-destroy':       { label: 'Destroy this', icon: '💥', color: '#e74c3c', category: 'game', params: {} },
  'game-pause':         { label: 'Pause game', icon: '⏸️', color: '#e74c3c', category: 'game', params: {} },
  // Motion extras
  'motion-glide':       { label: 'Glide to', icon: '🕊️', color: '#4a9eff', category: 'motion', params: { x: '0', y: '0', secs: '1' } },
  'motion-point':       { label: 'Point toward mouse', icon: '🎯', color: '#4a9eff', category: 'motion', params: {} },
  'motion-point-dir':   { label: 'Point in direction', icon: '🎯', color: '#4a9eff', category: 'motion', params: { direction: '90' } },
  'motion-setx':        { label: 'Set X to', icon: '🎭', color: '#4a9eff', category: 'motion', params: { x: '0' } },
  'motion-sety':        { label: 'Set Y to', icon: '🎭', color: '#4a9eff', category: 'motion', params: { y: '0' } },
  'motion-speed':       { label: 'Set speed to', icon: '⚡', color: '#4a9eff', category: 'motion', params: { speed: '5' } },
  // My Blocks
  'myblock-define':     { label: 'Define my block', icon: '🧩', color: '#ff6680', category: 'myblocks', params: { name: 'my block' } },
  'myblock-run':        { label: 'Run my block', icon: '🧩', color: '#ff6680', category: 'myblocks', params: { name: 'my block' } },
};
...
export function createBlockFromDrop(text, x, y) {
  ...
  return { id: Date.now() + Math.random(), type: 'custom', label: text, icon: '⚡', color: '#ec4899', category: 'custom', x, y, params: {} };
}
