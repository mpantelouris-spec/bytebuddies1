...
function SimCanvas({robotConfig,codeBlocks,runMode,stepTrigger,onProgress,onFpsUpdate,arenaType,challenge,onBlockActive}){
  ...
  useEffect(()=>{
    ...
    simEnvCanvas.width=256; simEnvCanvas.height=128;
    const simEnvCtx=simEnvCanvas.getContext('2d');
    const simGrad=simEnvCtx.createLinearGradient(0,0,0,128);
    simGrad.addColorStop(0,'#506080'); simGrad.addColorStop(0.5,'#9ab4d0'); simGrad.addColorStop(1,'#384050');
    simEnvCtx.fillStyle=simGrad; simEnvCtx.fillRect(0,0,256,128);
    simEnvCtx.fillStyle='rgba(255,255,255,0.15)'; simEnvCtx.fillRect(0,52,256,24);
