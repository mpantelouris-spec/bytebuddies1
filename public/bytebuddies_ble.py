# ByteBuddies wireless — copy of cutebot_ble_working.py (proven on micro:bit V2)
# I2C/Cutebot block is optional so bare boards do not show a sad face.
...
try:
    ...
    display.scroll(str(e)[:12], delay=80)
