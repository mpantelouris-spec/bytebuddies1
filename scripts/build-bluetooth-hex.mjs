...
// V2 wireless: embed proven cutebot_ble_working.py (hardware-tested)
const v2BlePy = 'cutebot_ble_working.py';
const generalHex = buildHexFromPy(v2BlePy);
writeHex('microbit-bluetooth-general.hex', generalHex);
writeHex('bytebuddies_ble.hex', generalHex);

const cutebotHex = buildHexFromPy('bytebuddies_cutebot_bluetooth.py');
writeHex('microbit-bluetooth-working.hex', cutebotHex);

writeHex('microbit-v2-bluetooth-general.hex', buildV2HexFromPy(v2BlePy));
writeHex('microbit-v2-bluetooth-working.hex', buildV2HexFromPy(v2BlePy));
